...
- Updated `The Prisoner` behavior.
    - No longer spawns jail cells, instead, you are chained to an anchor when attacked by the prisoner. The anchors can ben destroyed to break free of the chains.
