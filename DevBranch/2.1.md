...
- `Reconnaissance Duty` now shows faction banner of their faction color instead of red being enemy banner.
- Fixed `Russell` diaglogue and added easteregg dialogue. [[#210](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/218)]
