...
- Added passive to `arpon`. The butcher's apron. **Passive:** Splash effects from enemies are reflected by 200%, Ticks' damage to surrounding enemies takes twice the damage and stun duration.
