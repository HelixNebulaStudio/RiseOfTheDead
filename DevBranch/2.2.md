...
- Cultist spawned from `cultisthood` now has a 5 second delay before it can damage players. [[#544](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/544)]
