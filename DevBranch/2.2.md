...
- Fixed a case when over weapon customizations overrides the previous only selected due to delayed save. [[#607](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/607)]
> 2.1.17.3
