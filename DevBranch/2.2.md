...
- Adjusted storage slot cost to base on page to `clamp(5+((size-24) x (page or 1)), 5, 100)` from `clamp(5+((size-24)*(1)), 5, 25)`.
...
- Reduced `zenithcrate` max level from 560 to `math.floor(maxLevels/100)*100` = 500.
