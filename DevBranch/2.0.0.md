...
- `portableautoturret`'s power will now deplete if you take out the battery.
...
- Added natural spawn limit for naturally spawnning npcs due to spawn rate scales by player count now. [[#141](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/141)]
> 2.0.0.4
