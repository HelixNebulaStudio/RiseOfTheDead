...
function Mod.Activate(paramPacket)
	...
	local slowness = ModsLibrary.NaturalInterpolate(info.Upgrades[1].BaseValue, info.Upgrades[1].MaxValue, values["S"], info.Upgrades[1].MaxLevel);
