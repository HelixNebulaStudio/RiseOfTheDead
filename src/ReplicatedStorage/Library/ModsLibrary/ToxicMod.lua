...
function Mod.Activate(packet)
	...
	local rLayerInfo = modModsLibrary.GetLayer("R", packet);
...
if RunService:IsServer() then
	function Mod.OnActivate(toolHandler)
		local modLib = modModsLibrary.Get("toxicmod");
	...
	function Mod.ActivateMod(damageSource)
		...
		local bonusDmgRatio = modModsLibrary.NaturalInterpolate(0.05, 0.25, weaponItem.Values["R"], 10, 1.25);
