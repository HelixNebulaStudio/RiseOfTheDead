...
local GenericUpgrades = {
	AmmoCapacity={DataTag="AC"; Name="Ammo Capacity"; Syntax="Upgrade Ammo Capacity"; MaxLevel=10; BaseCost=5; MaxCost=50; BaseValue=0.3; MaxValue=3; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
}
...
Add{
	...
	Tier=1;
	Upgrades={	
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=5; MaxCost=100; BaseValue=0.05; MaxValue=0.5; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.5;};
	};
	Stackable=true;
	Type={"Pistol"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="FR"; Name="Rpm"; Syntax="Upgrade Fire Rate"; ValueType="Normal"; MaxLevel=10; BaseCost=6; MaxCost=60; BaseValue=10; MaxValue=100; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.5;};
	};
	Stackable=true;
	Type={"Pistol"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="RT"; Name="Reload Speed"; Syntax="Upgrade Reload Speed"; MaxLevel=10; BaseCost=4; MaxCost=50; BaseValue=0.05; MaxValue=0.75; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Pistol"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="AC"; Name="Ammo Capacity"; Syntax="Upgrade Ammo Capacity"; MaxLevel=10; BaseCost=5; MaxCost=50; BaseValue=0.3; MaxValue=3; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=true;
	Type={"Pistol"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="M"; Name="Magazine Size"; Syntax="Upgrade Magazine Size"; ValueType="Normal"; ValueDp=0; MaxLevel=9; BaseCost=3; MaxCost=30; BaseValue=1; MaxValue=10; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=true;
	Type={"Pistol"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="AC"; Name="Ammo Capacity"; Syntax="Upgrade Ammo Capacity"; MaxLevel=6; BaseCost=6; MaxCost=60; BaseValue=0.3; MaxValue=2; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=true;
	Type={"Pistol"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=5; MaxCost=100; BaseValue=0.05; MaxValue=0.5; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Submachine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="FR"; Name="Fire Rate"; Syntax="Upgrade Fire Rate"; ValueType="Normal"; MaxLevel=10; BaseCost=8; MaxCost=80; BaseValue=10; MaxValue=200; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.5;};
	};
	Stackable=true;
	Type={"Submachine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="RT"; Name="Reload Time"; Syntax="Upgrade Reload Speed"; MaxLevel=10; BaseCost=4; MaxCost=40; BaseValue=0.05; MaxValue=0.8; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Submachine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="AC"; Name="Ammo Capacity"; Syntax="Upgrade Ammo Capacity"; MaxLevel=10; BaseCost=5; MaxCost=50; BaseValue=0.6; MaxValue=5; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=true;
	Type={"Submachine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="HSM"; Name="Headshot Multiplier"; Syntax="Upgrade Headshot Multiplier"; ValueType="Normal"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.05; MaxValue=3; TweakBonus=2; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Submachine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="DS"; SliderTag="DSS"; Name="Scaler"; Prefix=""; Syntax="Upgrade Damage Scaler"; MaxLevel=10; BaseCost=7; MaxCost=70; BaseValue=-0.6; MaxValue=0.6; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=false;
	Type={"Submachine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=4;
	Upgrades={
		{DataTag="M"; Name="Multiplier"; Syntax="Upgrade Multiplier"; MaxLevel=10; BaseCost=8; MaxCost=80; BaseValue=0.3; MaxValue=3; TweakBonus=0.5; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Submachine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=4;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Split Damage"; MaxLevel=10; BaseCost=8; MaxCost=80; BaseValue=0.35; MaxValue=0.7; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
		{DataTag="FR"; Name="Fire Rate"; Syntax="Upgrade Fire Rate"; ValueType="Normal"; MaxLevel=10; BaseCost=8; MaxCost=80; BaseValue=5; MaxValue=75; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.1;};
	};
	Stackable=false;
	Type={"Submachine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=4;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=5; MaxCost=100; BaseValue=0.05; MaxValue=0.4; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.5;}; -- from 8;
		{DataTag="A"; Name="Accuracy"; Syntax="Upgrade Accuracy"; MaxLevel=10; BaseCost=5; MaxCost=50; BaseValue=0.05; MaxValue=0.4; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Submachine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=5; MaxCost=100; BaseValue=0.05; MaxValue=0.3; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Shotgun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="FR"; Name="Fire Rate"; Syntax="Upgrade Fire Rate"; ValueType="Normal"; MaxLevel=10; BaseCost=8; MaxCost=80; BaseValue=10; MaxValue=100; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.5;};
	};
	Stackable=true;
	Type={"Shotgun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="RT"; Name="Reload Time"; Syntax="Upgrade Reload Speed"; MaxLevel=10; BaseCost=4; MaxCost=40; BaseValue=0.05; MaxValue=0.5; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Shotgun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="AC"; Name="Ammo Capacity"; Syntax="Upgrade Ammo Capacity"; MaxLevel=10; BaseCost=5; MaxCost=50; BaseValue=0.3; MaxValue=4; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=true;
	Type={"Shotgun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="AC"; Name="Ammo Capacity"; Syntax="Upgrade Ammo Capacity"; MaxLevel=6; BaseCost=6; MaxCost=60; BaseValue=0.3; MaxValue=1; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=true;
	Type={"Shotgun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="P"; Name="Piercing"; Syntax="Add Piercing"; ValueType="Normal"; MaxLevel=1; BaseCost=20; MaxCost=20; BaseValue=0; MaxValue=1; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
	Type={"Shotgun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="RT"; Name="Reload Time"; Syntax="Upgrade Reload Speed"; MaxLevel=10; BaseCost=6; MaxCost=60; BaseValue=0.05; MaxValue=0.35; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Shotgun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=4;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=5; MaxCost=100; BaseValue=0.05; MaxValue=0.2; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
		{DataTag="A"; Name="Accuracy"; Syntax="Upgrade Accuracy"; MaxLevel=10; BaseCost=5; MaxCost=50; BaseValue=0.05; MaxValue=0.9; TweakBonus=0.05; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Shotgun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=6; MaxCost=110; BaseValue=0.05; MaxValue=0.3; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Rifle"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.05; MaxValue=0.25; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
		{DataTag="FR"; Name="Fire Rate"; Syntax="Upgrade Fire Rate"; ValueType="Normal"; MaxLevel=10; BaseCost=7; MaxCost=70; BaseValue=10; MaxValue=75; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.5;};
	};
	Stackable=false;
	Type={"Rifle"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="DS"; SliderTag="DSS"; Name="Scaler"; Prefix=""; Syntax="Upgrade Damage Scaler"; MaxLevel=10; BaseCost=7; MaxCost=70; BaseValue=-0.5; MaxValue=0.5; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=false;
	Type={"Rifle"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=3;
	Upgrades={
		{DataTag="M"; Name="Multiplier"; Syntax="Upgrade Multiplier"; MaxLevel=10; BaseCost=15; MaxCost=150; BaseValue=0.1; MaxValue=3; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Rifle"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=3;
	Upgrades={
		{DataTag="M"; Name="Multiplier"; Syntax="Upgrade Multiplier"; MaxLevel=10; BaseCost=8; MaxCost=80; BaseValue=0.3; MaxValue=3; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Rifle"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.05; MaxValue=0.2; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Sniper"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="FR"; Name="Fire Rate"; Syntax="Upgrade Fire Rate"; ValueType="Normal"; MaxLevel=10; BaseCost=8; MaxCost=80; BaseValue=5; MaxValue=50; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.5;};
	};
	Stackable=true;
	Type={"Sniper"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="AC"; Name="Ammo Capacity"; Syntax="Upgrade Ammo Capacity"; MaxLevel=10; BaseCost=5; MaxCost=50; BaseValue=0.1; MaxValue=2; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=true;
	Type={"Sniper"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="PB"; Name="Piercing"; Syntax="Upgrade Piercing"; ValueType="Normal"; MaxLevel=5; BaseCost=10; MaxCost=50; BaseValue=0; MaxValue=5; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
	Type={"Sniper"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="HSM"; Name="Headshot Multiplier"; Syntax="Upgrade Headshot Multiplier"; ValueType="Normal"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.05; MaxValue=2; TweakBonus=0.5; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Sniper"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="M"; Name="Multiplier"; Syntax="Upgrade Multiplier"; MaxLevel=10; BaseCost=15; MaxCost=150; BaseValue=0.2; MaxValue=2; TweakBonus=0.5; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Sniper"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="SF"; Name="Focus Rate"; Syntax="Upgrade Focus Rate"; MaxLevel=10; BaseCost=5; MaxCost=30; BaseValue=0.4; MaxValue=0.8; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.05; MaxValue=0.5; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="RT"; Name="Reload Time"; Syntax="Upgrade Reload Speed"; MaxLevel=10; BaseCost=2; MaxCost=20; BaseValue=0.05; MaxValue=0.5; TweakBonus=0.2; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Heavy machine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="RFR"; Name="Rev Up Rate"; Syntax="Increase Rate"; MaxLevel=10; BaseCost=12; MaxCost=120; BaseValue=0.1; MaxValue=0.8; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Heavy machine gun"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0; MaxValue=0.3; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Pyrotechnic"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="AC"; Name="Ammo Capacity"; Syntax="Upgrade Ammo Capacity"; MaxLevel=10; BaseCost=5; MaxCost=50; BaseValue=0.6; MaxValue=2; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=true;
	Type={"Pyrotechnic"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="BD"; Name="Duration"; Syntax="Increase Duration"; ValueType="Normal"; Suffix="s"; MaxLevel=9; BaseCost=9; MaxCost=90; BaseValue=3; MaxValue=30; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=true;
	Type={"Pyrotechnic"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="F"; Name="Knockback Force"; Syntax="Increase Force"; ValueType="Normal"; Suffix=" units/s"; MaxLevel=5; BaseCost=10; MaxCost=100; BaseValue=25; MaxValue=75; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
	Type={"Flamethrower"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.1; MaxValue=0.2; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Explosive"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="AC"; Name="Ammo Capacity"; Syntax="Upgrade Ammo Capacity"; MaxLevel=10; BaseCost=5; MaxCost=50; BaseValue=0.3; MaxValue=1.5; TweakBonus=0.5; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=true;
	Type={"Explosive"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="R"; Name="Radius"; Syntax="Upgrade Radius"; ValueType="Normal"; MaxLevel=8; BaseCost=9; MaxCost=90; BaseValue=1; MaxValue=9; TweakBonus=5; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=true;
	Type={"Explosive"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=3;
	Upgrades={
		{DataTag="FR"; Name="Rpm"; Syntax="Upgrade Fire Rate"; ValueType="Normal"; MaxLevel=10; BaseCost=6; MaxCost=60; BaseValue=10; MaxValue=120; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.5;};
	};
	Stackable=false;
	Type={"Rocket"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=3;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.05; MaxValue=0.2; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.5;};
	};
	Stackable=true;
	Type={"Bow"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=3;
	Upgrades={
		{DataTag="R"; Name="Radius"; Syntax="Increase Scan Radius"; ValueType="Normal"; MaxLevel=8; BaseCost=10; MaxCost=100; BaseValue=16; MaxValue=64; TweakBonus=6; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
	Type={"Bow"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.03; MaxValue=0.25; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
		{DataTag="W"; Name="Piercing"; Syntax="Increase Piercing"; ValueType="Normal"; MaxLevel=7; BaseCost=10; MaxCost=100; BaseValue=1; MaxValue=8; TweakBonus=1; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
	Type={"Bow"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="RT"; Name="Reload Time"; Syntax="Upgrade Reload Speed"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.05; MaxValue=0.5; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Launcher"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="C"; Name="Chance"; Syntax="Upgrade Chance"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.2; MaxValue=0.7; TweakBonus=0.05; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1;};
	};
	Stackable=false;
	Type={"Sniper"; "Bow"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="F"; Name="Fire Rate"; Syntax="Upgrade Fire Rate"; MaxLevel=10; BaseCost=8; MaxCost=80; BaseValue=0.1; MaxValue=0.5; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=1.5;};
	};
	Stackable=false;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="D"; Name="Flat Damage"; Syntax="Upgrade Damage"; ValueType="Normal"; MaxLevel=10; BaseCost=20; MaxCost=200; BaseValue=5; MaxValue=100; TweakBonus=20; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
		{DataTag="T"; Name="Duration"; Syntax="Upgrade Duration"; ValueType="Normal"; Suffix="s"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=5; MaxValue=25; TweakBonus=5; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage Percent"; MaxLevel=10; BaseCost=20; MaxCost=200; BaseValue=0.1; MaxValue=0.75; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
		{DataTag="T"; Name="Targets"; Syntax="Increase Targets"; ValueType="Normal"; MaxLevel=5; BaseCost=10; MaxCost=100; BaseValue=1; MaxValue=6; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
	Type={"Pistol"; "Submachine gun"; "Shotgun"; "Rifle"; "Sniper"; "Heavy machine gun"; "Bow";};
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="S"; Name="Radius"; Syntax="Increase Radius"; ValueType="Normal"; MaxLevel=7; BaseCost=10; MaxCost=100; BaseValue=1; MaxValue=15; TweakBonus=8; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
		{DataTag="T"; Name="Targets"; Syntax="Increase Targets"; ValueType="Normal"; MaxLevel=7; BaseCost=10; MaxCost=100; BaseValue=1; MaxValue=8; TweakBonus=2; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
	Type={"Pistol"; "Submachine gun"; "Shotgun"; "Rifle"; "Sniper"; "Heavy machine gun"; "Bow";};
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="R"; Name="Reduction"; Syntax="Increase Reduction"; MaxLevel=10; BaseCost=20; MaxCost=200; BaseValue=0.05; MaxValue=0.75; TweakBonus=0.1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
		{DataTag="T"; Name="Duration"; Syntax="Increase Duration"; ValueType="Normal"; Suffix="s"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=3; MaxValue=30; TweakBonus=10; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Pistol"; "Submachine gun"; "Shotgun"; "Rifle"; "Sniper"; "Heavy machine gun"; "Bow";};
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="D"; Name="Damage"; Syntax="Upgrade Damage"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.1; MaxValue=5; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Edged Melee"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="KB"; Name="Knockback"; Syntax="Upgrade Knockback"; MaxLevel=10; BaseCost=6; MaxCost=60; BaseValue=0.1; MaxValue=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=true;
	Type={"Blunt Melee"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=2;
	Upgrades={
		{DataTag="D"; Name="Duration"; Syntax="Upgrade Duration"; ValueType="Normal"; Suffix="s"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.5; MaxValue=5.5; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
	Type={"Blunt Melee"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="S"; Name="Slots"; Syntax="Increase Slots"; ValueType="Normal"; MaxLevel=2; BaseCost=5; MaxCost=50; BaseValue=1; MaxValue=3; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
	Type={"Utility Wear"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="AP"; Name="Armor Points"; Syntax="Upgrade Armor"; ValueType="Normal"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=10; MaxValue=50; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable={
		["Armor Mods"]=false;
	};
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="R"; Name="Reflected Percent"; Syntax="Upgrade Percent"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.1; MaxValue=0.7; TweakBonus=0.05; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve; Rate=2;};
	};
	Stackable=false;
	Type={"Chest"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="HP"; Name="Health Points"; Syntax="Increase Health"; ValueType="Normal"; MaxLevel=9; BaseCost=10; MaxCost=100; BaseValue=5; MaxValue=50; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable={
		["Health Mods"]=false;
	};
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="A"; Name="Amplifier"; Syntax="Upgrade"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.1; MaxValue=1; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;Rate=1.1;};
	};
	Stackable=false;
	Type={"Chest"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="AP"; Name="Armor Points"; Syntax="Upgrade Armor Points"; ValueType="Normal"; Suffix="ap"; MaxLevel=5; BaseCost=10; MaxCost=100; BaseValue=0; MaxValue=100; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
		{DataTag="AR"; Name="Armor Rate"; Syntax="Upgrade Armor Rate"; ValueType="Normal"; MaxLevel=5; Suffix="ap/s"; BaseCost=10; MaxCost=100; BaseValue=0; MaxValue=10; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable={
		["Armor Mods"]=false;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="HPK"; Name="Health Per Kill"; Syntax="Increase Health Per Kill"; ValueType="Normal"; MaxLevel=5; BaseCost=10; MaxCost=100; BaseValue=0; MaxValue=10; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
		{DataTag="HP"; Name="Max Health"; Syntax="Increase Max Health"; ValueType="Normal"; MaxLevel=5; BaseCost=10; MaxCost=100; BaseValue=0; MaxValue=100; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable={
		["Health Mods"]=false;
		["Pacifists & Warmongers"]=false;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="T"; Name="Time"; Syntax="Increase Time"; ValueType="Normal"; Suffix="s"; MaxLevel=9; BaseCost=10; MaxCost=100; BaseValue=0.1; MaxValue=1; Scaling=ItemModsLibrary.ScalingStyle.Linear;};
	};
	Stackable=false;
	Type={"Chest"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="F"; Name="Flinch Protection"; Syntax="Upgrade Flinch Protection"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.05; MaxValue=0.75; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Head"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="GR"; Name="Grip Resistance"; Syntax="Increase Grip Resistance"; ValueType="Normal"; MaxLevel=10; BaseCost=4; MaxCost=40; BaseValue=10; MaxValue=100; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Gloves"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
...
Add{
	...
	Tier=1;
	Upgrades={
		{DataTag="AS"; Name="Attack Speed"; Syntax="Increase Attack Speed"; MaxLevel=10; BaseCost=10; MaxCost=100; BaseValue=0.02; MaxValue=0.07; Scaling=ItemModsLibrary.ScalingStyle.NaturalCurve;};
	};
	Stackable=false;
	Type={"Gloves"};
	EffectTrigger=ItemModsLibrary.EffectTrigger.Passive;
