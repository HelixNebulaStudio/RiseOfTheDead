...
local rbxCmds = {c=true; whisper=true; w=true; mute=true; unmute=true; e=true; emote=true; join=true; j=true; update=true;};

--This is only for main menu;
local function Run(ChatService)
	ChatService:RegisterProcessCommandsFunction("command", function (speakerName, message, channelId)
		...
		Debugger:Log("RegisterProcessCommandsFunction Menu")
