...
local function calculateRawMoveVectorRoot(humanoid: Humanoid, cameraRelativeMoveVector: Vector3): Vector3
	...
	--	return root.CFrame:VectorToWorldSpace(cameraRelativeMoveVector)
	--end
	
	local cameraCFrame = root.CFrame
...
function ControlModule:OnRenderStepped(dt)
	if self.activeController and self.activeController.enabled and self.humanoid then
		...
		if cameraRelative then
			...
			moveVector = calculateRawMoveVectorRoot(self.humanoid, moveVector);
		end
