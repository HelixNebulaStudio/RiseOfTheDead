...
Dialogues.Victor.Dialogues = function()
	return {
		{Tag="vt2_cultist"; Face="Suspicious";
			Dialogue="A group of cultists are hunting me, and one of them dropped this note."; 
			Reply="Oh yeah, I forgot to tell you, the tombs were apart of their lair. "};
		{Tag="vt2_cultist2"; Face="Grumpy";
			Dialogue="Why do they call you The Venator?"; 
			Reply="Dude, that doesn't matter. What matters is getting rid of the cultist. What else does the note say?"};
		{Tag="vt2_cultist3"; Face="Suspicious";
			Dialogue="Umm, \"retrieve the mask immediately before they unleash hellfire upon everyone\".. What do they mean by that?"; 
			Reply="Err, umm, yeah.. *Looks away* I don't know either.. Like I said, what matters is getting rid of these cultists."};
		
		{Tag="vt2_outfit"; Face="Skeptical";
