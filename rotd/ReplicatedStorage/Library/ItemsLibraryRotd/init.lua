...
function modItemsLibrary.onRequire()
    ...
    new(meleeBase, {Id="fireaxe"; Name="Fire Axe"; Icon="rbxassetid://12865194088"; Tags={"Edged Melee"}; Description="Not exactly an axe on fire.\n<b>[Passive] Axe of Fire:</b> Ignite enemies for 4 seconds dealing PreModDamage x number of stacks. Each hit doubles the stacks, but does not refresh debuff duration.";});
    ...
    new(meleeBase, {Id="inquisitorssword"; Name="The Inquisitor's Sword"; Icon="rbxassetid://12163013682"; Tradable=modItemsLibrary.Tradable.Nontradable; Tags={"Edged Melee"; "Unobtainable"}; Description="The Inquisitor's Sword, earned by contributing to the inquisition of bugs and testing in Rise of the Dead.";});
    ...
    new(throwableBase, {Id="molotov"; Name="Molotov"; Icon="rbxassetid://5088295501"; Tags={"Incendiary"}; Description="Ignites surrounding area on fire on impact, does 1% (Min: 25 damage) of the enemies' max health every 0.5 seconds.";});
    ...
    local clothingBase = {
        ...
        OnInstantiate=function(storageItem, itemData)
            if not modItemsLibrary:HasTag(storageItem.ItemId, "Head") then return end;
    ...
    new(clothingBase, {Id="nekronmask"; Name="Nekron Mask"; Icon="rbxassetid://5419783427"; Tags={"Head"}; DestroyOnExpire=true; Description="Once you put it on, the mask will start consuming itself and some zombies will start looking like you.. (It will continue to consume even if you take the mask off.)"; Sources={"Obtained in <b>Mission: Vindictive Treasure</b>";};  });
    ...
    new(clothingBase, {Id="santahat"; Name="Santa Hat"; Tradable=modItemsLibrary.Tradable.Tradable; Icon="rbxassetid://6108356239"; Tags={"Head"; "Christmas"; "Frostivus"}; Description="Merry Christmas, ho ho ho!\n\n<b>[Passive] Colored Gifts:</b> Increases the drop rate of specific colored <b>Frostivus</b> gifts based on your hat color. (Default: Red)";});
    new(clothingBase, {Id="greensantahat"; Name="Green Santa Hat"; Tradable=modItemsLibrary.Tradable.Tradable; Icon="rbxassetid://6122942270"; Tags={"Head"; "Christmas"; "Frostivus"}; Description="Merry Christmas, ho ho ho!\n\n<b>[Passive] Colored Gifts:</b> Increases the drop rate of green <b>Frostivus</b> gifts based on your hat color.";});
    ...
    local resourcePackageBase = {
        ...
        OnAdd = function(data)
            ...
            local itemLib = modItemsLibrary:Find(resourceItemId);
    ...
    new(commodityBase, {Id="purplelemon"; Name="Purple Lemon"; Icon="rbxassetid://7188572954"; Stackable=3; Tradable=modItemsLibrary.Tradable.PremiumOnly; Description="Purple colored lemons..?";});
    new(commodityBase, {Id="gps"; Name="GPS"; Tags={"Tool";}; Icon="rbxassetid://5932231243"; Stackable=false; Usable="Use"; Equippable=true; Description="The item to get you home. Global Positioning System. Used to guide and fast travel to different locations by paying R.A.T. members. Press [E] to select a location.";});
    new(commodityBase, {Id="wateringcan"; Name="Watering Can"; BaseValues={Water=100}; Tags={"Tool";}; Icon="rbxassetid://5191385023"; Stackable=false; Equippable=true; Description="Used for watering plants.";});
    ...
    new(commodityBase, {Id="boombox"; Name="Boombox"; Tags={"Tool";}; Icon="rbxassetid://4997111675"; Stackable=false; Equippable=true; BaseValues={Power=100}; Description="Used to annoy your neighbors. Press [E] to add custom tracks.";});
    ...
    new(commodityBase, {Id="floodlights"; Name="Flood Lights"; Icon="rbxassetid://99988201302336"; Description="<b>Tier 4 Commodity</b>\nA powerful spot light for emergencies.";});
    ...
    new(usableBase, {Id="mpbook"; Name="Latest Grinding Guide Publication"; Icon="rbxassetid://17419949268"; Tradable=modItemsLibrary.Tradable.Nontradable; Tags={"Misc Usable"};
        Stackable = false;
    ...
    local skinPermBase = {
        ...
        OnAdd = function(data)
            ...
            if skinPerm then
                local itemLib = modItemsLibrary:Find(data.TargetItemId);
    ...
    --==========================================================[[ KEY ]]==========================================================--
    local keyBase = {
        Type = modItemsLibrary.Types.Key;
        Tradable = modItemsLibrary.Tradable.Tradable;
    };
    ...
    new(customizationPack, {Id="skineaster2023"; Name="Easter Skins 2023 Pack"; Icon="rbxassetid://12963885465"; Tags={"Skin Pack"; "Easter"}; UnlockPack={Type="SkinsPacks"; Id="Easter2023";};});
    ...
    new(skinPermBase, {Id="xmassweatersnowflakeblue"; Icon="rbxassetid://99198676650490"; SkinPerm="Blue Snowflake"; TargetItemId="xmassweater"; Tags={"Christmas"; "Frostivus";};});
    new(skinPermBase, {Id="brownbeltxmasorange"; Icon="rbxassetid://119905732158933"; SkinPerm="Xmas Orange"; TargetItemId="brownbelt"; Tags={"Christmas"; "Frostivus";};});
    new(skinPermBase, {Id="brownbeltxmaspink"; Icon="rbxassetid://97310653356411"; SkinPerm="Xmas Pink"; TargetItemId="brownbelt"; Tags={"Christmas"; "Frostivus";};});
    ...
    --==========================================================[[ META ]]==========================================================--
    local metaBase = {
        Type = modItemsLibrary.Types.None;
        Tradable = modItemsLibrary.Tradable.Nontradable;
        Stackable = false;
    };
    ...
    new(crateBase, {Id="unknowncrate"; Name="Unknown Crate"; Icon="rbxassetid://10980446265"; Description="Recycler's unknown crate."; Type=modItemsLibrary.Types.None; Tags={"Unobtainable"};});
    ...
    for _, obj in pairs(script:GetChildren()) do
        ...
        modItemsLibrary.loadModule(obj);
    end
end
