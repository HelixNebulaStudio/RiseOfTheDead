...
function modItemsLibrary.onRequire()
    ...
    new(commodityBase, {Id="wateringcan"; Name="Watering Can"; Tags={"Tool";}; Icon="rbxassetid://5191385023"; Stackable=false; Equippable=true; Description="Used for watering plants.";});
