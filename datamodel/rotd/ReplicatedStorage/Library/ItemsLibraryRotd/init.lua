...
function modItemsLibrary.onRequire()
    ...
    new(commodityBase, {Id="gps"; Name="GPS"; Tags={"Tool";}; Icon="rbxassetid://5932231243"; Stackable=false; Usable="Use"; ContextOrder="Usable"; Equippable=true; Description="The item to get you home. Global Positioning System. Used to guide and fast travel to different locations by paying R.A.T. members. Press [E] to select a location.";});
