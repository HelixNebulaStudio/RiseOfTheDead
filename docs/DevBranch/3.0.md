...
<img src="../assets/images/screenshots/modifierbreakdown.jpg" width="60%" alt="modifierbreakdown">
...
<img src="../assets/images/items/dualuzi.png" width="10%" alt="dualuzi">

- New Tier 5 Submachine gun, **Dual Uzi**. With a built-in **Propeller Stock** that propels you forward.

<img src="../assets/images/items/icepicks.png" width="10%" alt="icepicks">

- New Tier 4 Edged Melee, **Ice Picks**.

<img src="../assets/images/items/greavesandsabatons.png" width="10%" alt="greavesandsabatons">

- Added new shoes, **Greaves and Sabatons**. Passive: **Chivalrous Kick**, Sliding into enemies knocks the away.

<img src="../assets/images/items/pouchvest.png" width="10%" alt="pouchvest">

- Added new chest clothing, **Pouch Vest**. Passive: **Bullet Recouper**, Hitscan shots that missed have a 50% chance to be recouped.

<img src="../assets/images/items/pointguardbulwark.png" width="10%" alt="pointguardbulwark">
...
<img src="../assets/images/items/damagedividermod.png" width="10%" alt="damagedividermod">
...
<img src="../assets/images/items/healthreaper.png" width="10%" alt="healthreaper">

- New Melee modifier, **Melee Health Reaper**.
	- Killing 3 enemies within a time window heals you.
	
<img src="../assets/images/items/crimsonofferings.png" width="10%" alt="crimsonofferings">
<img src="../assets/images/items/azureofferings.png" width="10%" alt="sageofferings">
<img src="../assets/images/items/sageofferings.png" width="10%" alt="sageofferings">
...
<img src="../assets/images/screenshots/emotewheel.jpg" width="60%" alt="emotewheel">

- New **Emote Wheel**, now used for social gameplay. Emoting, sound quips, spray tags, emoji bubbles. Default Key is **C**.

<img src="../assets/images/screenshots/portablestorage.jpg" width="40%" alt="portablestorage">
...
<img src="../assets/images/screenshots/SeeingRed.png" width="10%" alt="SeeingRed">
...
<img src="../assets/images/screenshots/swamplands.jpg" width="80%" alt="swamplands">
...
<img src="../assets/images/screenshots/ShadowStrangle.png" width="20%" alt="ShadowStrangle">
