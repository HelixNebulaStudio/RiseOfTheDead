...
- Potentially fix a crashing bug relating to when Npcs are streamed in because of StreamingEnabled. [[#779](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/779)]
> 2.2.5.2

- Added checks to ensure lazy loaded to be loaded before attempt to use them.
- Added checks to ensure models are loaded on client before continue equipping. [[#480](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/480)]
- Fixed drop item glow showing up for in The Beginning cutscene.
- Fixed RichText not enabled on quantity option menu. [[#922](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/922)]
> 2.2.5.1

- Fixed opening cutscene camera. [[#896](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/896)]
- Fixed disguise kit not showing the uncapped amount of kills when it is capped in code. [[#895](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/895)]
- Fixed opening cutscenes for worlds Sunken Ship and Genesis.
- Fixed skin shop preview not applying skin. [[#913](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/913)]
- Fixed skins not loading on `portableautoturret`. [[#908](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/908)]
- Fixed skin permanent Polaris couldn't be applied. [[#914](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/914)]
- Adjusted normal survival drop order and drop starts from wave 5 onwards and drops every 3 waves. [[#910](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/910)]
- Belly of the Beast now removes Sunken Salvages board mission if it's already complete to be added agin.
> 2.2.4.4

- Added `militarygloves` and `militaryglovesfingerless` unlockable.
- Hotbar now refresh when toggled visibility. [[#905](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/905)]
...
- QoL: Improved interact key handling with proper handling priority.
    ...
    - Interact to close windows (if opened) such as `engineersplanner`, `gps`, etc.. has priority index of 5.
    - Interact to open equipped tool windows such as `engineersplanner`, `keytar`, maps, has priority index of 10.
    - If any windows is opened and interact was not handled, least prioritized will close all closable windows.
> 2.2.4.2

- Removed client ui loading delay due to loading player's avatar image for trade interface.
- Added backblast particles for `at4`.
- Added `grandgarand` idle animation. [[#886](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/886)]
> 2.2.4.1

- Fixed special event scripts not loading in certain worlds.
- Fixed dying in first person bugs camera. [[#881](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/881)]
> 2.2.4.0

- Fixed player visibility not updating when camera change. [[#859](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/859)]
- Fixed typo to disable Santa hat spawning on Witherers. [[#784](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/784)]
- Mission Belly of the Beast now ignores other items in the crate to progress. [[#869](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/869)]
    - Added `/mission77 tpcratestome` to tp Eaten Sunken Crate to player to make testing more efficient.
- Use new EventService to improve handling for events when exiting boss rooms after defeating a boss for a mission. [[#872](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/872)]
- Removed tax on `m9legacy`. [[#876](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/876)]
- Added sell price for `sandwich` and `ziphoningserum`. [[#877](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/877)]
- Added sell price for `grandgarandparts` [[#877](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/877)]
- Fixed case `snowsledge` trying to load when character isn't loaded yet. [[#824](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/824)]
- `ammopouch` charges are now universal instead of per ammo pouch. [[#846](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/846)]
- Fixed ammo desync when hovering over a weapon in inventory. [[#864](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/864)]
- Fixed being able to acquire multiple Frostivus skin on the same weapon. [[#848](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/848)]
- Fixed `skullburstmod` breaks weapons when unequipping. [[#866](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/866)]
- Fixed `frenzydamagemod` breaks weapons when unequipping. [[#857](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/857)]
- Fixed `grandgarand` bullet part missing customization layer and magazine base color. [[#842](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/842)] 
- Fixed `grandgarand` model collision. [[#861](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/861)]
- Fixed Engineer's Planner not working after dying. [[#871](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/871)]
...
- Fixed Joint motion step jitters when enabled. [[#854](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/854)]
- Fixed Victory popup not showing up if you close mission menu after winning a round of Buried Presents. [[#850](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/850)] 
- Fixed unconfigurated TextChatService on TheUnderground. [[#853](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/853)]
- Fixed `/reloadchar` not reloading some aspects properly. [[#851](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/851)]
- QoL: When Chat UI is resetted, commands history and unentered text is saved. E.g. Dying while typing.
- Fixed client commands not processing. [[#852](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/852)]
- Fixed Event Pass complete notification when leveling up after completing event pass. [[#849](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/849)]
> 2.2.3.0

- Disabled Oily in normal survival.
- Fixed P250 collision. [[#843](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/843)]
- Fixed event pass not leveling up. [[#840](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/840)]
> 2.2.2.0

- Fixed status not ready issue appearantly occuring for the second players onward joining the server.
    - Status Ready causing ragdoll on server side only. [[#826](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/828)]
    - Status Ready causing players after first not loading properly [[#839](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/839)]
    - Status Ready causing clothing loading issues. [[#824](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/824)]
    - Status Ready causing explosion handler to halt due to waiting for player status to apply knock up effect. [[#772](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/772)]
- Fixed menu response in main menu. [[#835](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/835)]
- Fixed leveling up Frostivus after completing the event pass not awarding the badge. [[#836](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/836)]
- Fixed Gingerbread applies Antique instead of Gingerbread. [[#838](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/838)]
    - `arelshiftcrossgingerbread` can be claimed again.
> 2.2.1.0

- Hid shop sell for gift tokens option since there is no gift shop this event. [[#829](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/829)]
- Fixed skin item name. [[#832](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/832)]
- Fixed applying skins stating unavailable. [[#830](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/830)]
- Adjusted client scripts loading to fix script loading issues caused by character resetting. [[#772](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/772)]
- Fixed faces on the P250 lock part. [[#825](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/825)]
- Fixed missing Blue Snowflake unlockable for Xmas Sweater. [[#823](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/823)]
> 2.2.0.3

- Increased Zombie movespeed cap from 30 to 35.
- Capped Dr. Sinister max health to 100k.
- Fixed missing use option. [[#818](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/818)]
- Adjusted Winter Treelum spawn position. [[#819](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/819)]
- Adjust code for BulletRicochet that may be causing ammo desync [[#821](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/821)]
- Reduced Winter Treelum summon interaction time to 2s. [[#820](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/820)]
- Added Frostivus 2024 Completion Badge for reaching event pass level 100+. [[#822](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/822)]
- Fixed buried presents loading multiple times. [[#811](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/811)]
- Fixed Frostivus event systems not working if Mr Klaws is not in the world. [[#816](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/816)]
- Updated outdated gift description. [[#814](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/814)]
- Fixed explosions. [[#813](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/813)]
- Fixed tools interaction menus. E.g. Map, Engineer's Planner, etc.. [[#810](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/810)] [[#812](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/812)]
- Updated mission Monorails objective to reach wave 5 for completeion. [[#809](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/809)]  
> 2.2.0.2

- Fixed survival next wave reward icon. [[#809](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/808)]
- Fixed Sunken Slavages instantly respawning after interacting. [[#750](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/750)]
- Fixed polish progression bar. [[#742](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/742)]
- Adjusted leap tracjectory detection. [[#764](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/764)]
- Added check before continuing spawning bandits in Medical Breakthrout. [[#782](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/782)]
- All droptable level requirement are now capped at 300.
- Reduced all extreme boss level requirements to scale by 50. [[#795](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/795)]
- Fixed `grenadelauncher` orientation on PaT. [[#525](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/525)]
- Fixed `chainsaw` not playing attack animation. [[#696](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/696)]
- Fixed Zomborg Prime stunning from explosive barrels. [[#754](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/754)] 
- Added some audio preload calls to improve experience. [[#748](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/748)]
- Improved damage tick for corrosive puddles. [[#648](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/648)] 
- Fixed Tombs continuing after status changed from in progress. [[#783](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/783)]
- Fixed boombox. [[#653](https://github.com/HelixNebulaStudio/RiseOfTheDead/issues/653)]
...
- Reduced player body motors sync data usage between server and client by ~73%. <details>
  <summary>Details</summary>
    ...
    ![bodyMotorsOptimizations](../assets/images/bodyMotorsOptimizations.png)
